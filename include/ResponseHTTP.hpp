...
class ResponseHTTP
{
	private:
		...
		char			**create_env(RequestParser &rp, string cgi_script, string file_location, t_error error);
		int				handle_cgi_request(RequestParser &rp, string cgi_script, string file_location, t_error error);
